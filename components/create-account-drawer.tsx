...
const CreateAccountDrawer = ({ children }: CreateAccountDrawerProps) => {
  ...
  // 🔹 Fetch hook for creating accounts
  const {
    data: newAccount,
    error,
    fn: createAccountfn,
      ...
      <DrawerContent>
        ...
        <div className="px-4 pb-6">
          ...
          >
            ...
            {/* 🔸 Default Account Switch */}
            <div className="flex items-center justify-between rounded-lg border p-3 transition-all hover:bg-muted/40">
              <div>
                <label
                  htmlFor="isDefault"
                  className="text-sm font-medium cursor-pointer"
